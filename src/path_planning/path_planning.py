...
#         start and goal coordinates (r, c) where r is the row and c is the column
...
def get_global_path(map, start, goal):
    # Define robot size
    robot_width = 12
    ...
    # Always include the goal as the final checkpoint
